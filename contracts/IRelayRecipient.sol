...
contract IRelayRecipient {
     ...
     */
    function acceptRelayedCall(address relay, address from, bytes memory encodedFunction, uint gasPrice, uint transactionFee, uint gasLimit, bytes memory approvalData) public view returns (bytes memory context);
     ...
     */
    function preRelayedCall(bytes memory context) public returns (bytes memory outcontext);
